      ...
      <div className="container px-4 mx-auto relative z-10 max-w-6xl">
        <FadeIn className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Whether you have a question, a project opportunity, or just want to connect, my inbox is open.
          </p>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <FadeIn direction="right" className="space-y-8">
            ...
            <div className="glass-card p-6 md:p-8 rounded-3xl border border-border/50 flex flex-col gap-8">
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href={`mailto:${portfolioData.personal.email}`} className="text-muted-foreground hover:text-cyan-400 transition-colors">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href={`tel:${portfolioData.personal.phone}`} className="text-muted-foreground hover:text-cyan-400 transition-colors">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <Button asChild variant="outline" size="lg" className="glass rounded-full hover:bg-white/10 flex-1">
                   <Link href={portfolioData.personal.links.github} target="_blank">
                     <Github className="w-5 h-5 mr-2 text-cyan-500" /> GitHub
                   </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="glass rounded-full hover:bg-white/10 flex-1">
                   <Link href={portfolioData.personal.links.linkedin} target="_blank">
          ...
          <FadeIn direction="left">
            ...
            <form onSubmit={handleSubmit} className="glass-card p-6 md:p-8 rounded-3xl border border-border/50 flex flex-col gap-6">
