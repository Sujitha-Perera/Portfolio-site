...
const getFilters = () => {
  ...
  const counts = allTechs.reduce((acc, tech) => {
...
export default function ProjectsPage() {
  ...
  const filteredProjects = activeFilter === ALL_FILTER
    ? portfolioData.projects
    : portfolioData.projects.filter(p => p.techStack.includes(activeFilter));
    ...
    <div className="min-h-screen py-24 relative overflow-hidden">
      ...
      <div className="container px-4 mx-auto relative z-10">
        <FadeIn className="text-center max-w-2xl mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 text-glow">Projects</h1>
          <p className="text-lg text-muted-foreground">
            A showcase of my technical work, from full-stack applications to AI models and responsive UIs.
          </p>
        </FadeIn>
        ...
        {filteredProjects.length === 0 && (
          <FadeIn className="text-center py-24">
            <p className="text-muted-foreground text-lg">No projects found with this technology.</p>
            <Button
              variant="outline"
