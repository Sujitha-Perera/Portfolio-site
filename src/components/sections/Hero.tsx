        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left">
            <FadeIn>
              ...
              <span className="font-bold text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400 drop-shadow-md">SUJITHA PERERA</span>
              </h2>
            </FadeIn>
            ...
            <FadeIn delay={0.3} className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <Button asChild size="lg" className="bg-cyan-600 hover:bg-cyan-700 text-white rounded-full px-8">
                <Link href="/projects">
                  View Projects <ArrowRight className="ml-2 w-4 h-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="rounded-full px-8 glass hover:bg-white/10">
                <Link href="/contact">Contact Me</Link>
              </Button>
              
              <div className="flex items-center gap-2 ml-2">
                <Button asChild variant="ghost" size="icon" className="rounded-full hover:bg-white/10 hover:text-cyan-400">
          ...
          {/* Profile Photo */}
          <FadeIn delay={0.2} direction="left" className="w-full max-w-sm lg:max-w-md">
